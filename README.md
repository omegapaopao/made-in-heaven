<p align="center">
  <img src="https://img.shields.io/badge/version-1.3.0-818cf8?style=for-the-badge" alt="version">
...
市面上所有视频倍速脚本都在做同一件事：调用 `video.playbackRate`，然后被浏览器 16× 上限卡死。但 **made in heaven** 远不止于此。

当倍速超过 16× 时，**Turbo 超高速引擎**自动接管：Canvas 逐帧渲染 + 跳帧补偿算法，在浏览器底层限制之上强行突破至 50 倍速。原生模式和 Turbo 模式无缝切换，用户无感。
...
| 🚀 **Turbo 超高速引擎** | Canvas 帧跳进 + AudioContext，突破浏览器 16× 硬限制，直达 50× |
| 📦 **极致轻量** | 仅 19KB，无任何依赖，Tampermonkey 注入即用 |
| 🎯 **50 倍速上限** | 0.1× ~ 50× 任意倍速，智能切换原生 / Turbo 双模驱动 |
